...
- Se a pessoa exerceu o cargo apenas de forma interina, substituta, provisória ou “em exercício”, não trate isso como titularidade.
- Nesse caso, informe claramente:
“Exercício interino/substituto confirmado; titularidade não confirmada.”
...
- Quando houver fonte oficial original do próprio órgão, não use cópias em sites de terceiros como base principal.
...
- Não afirme competência formal por analogia.
...
- Se exerceu apenas de forma interina, substituta ou provisória, indique isso claramente.
- Esfera:
- Poder ou estrutura:
- Tipo de cargo:
