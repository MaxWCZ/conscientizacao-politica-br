...
- Se uma pessoa for informada, verifique antes se ela exerceu esse cargo no período indicado.
- Se o vínculo pessoa-cargo não for confirmado, não atribua as competências do cargo à pessoa. Explique apenas o cargo em geral.
...
Regras de fonte:
- Fonte INDIRETA pode complementar, mas não confirmar o dado principal.
- Não use Wikipedia como base principal.
- Não use redes sociais como confirmação.
...
- Se houve pessoa informada, o vínculo foi confirmado?
